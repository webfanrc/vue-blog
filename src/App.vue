  ...
  <div style="height: 100%;">
    ...
    <div id="footer_nav">
      <footer id="footer">
        ...
        <a href="https://www.linkedin.com/in/xieruochen"><i class="svg-icon linkedin"></i></a>
        <a href="https://www.jianshu.com/u/4aff4c1f4f55"><i class="svg-icon jianshu"></i></a>
      </footer>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      toggle_dark() {
        ...
        document.getElementById('footer_nav').classList.add('dark');

        document.getElementById('app').classList.remove('light');
        document.getElementById('footer_nav').classList.remove('light');
      },
      toggle_light() {
        document.getElementById('app').classList.remove('dark');
        document.getElementById('footer_nav').classList.remove('dark');

        document.getElementById('app').classList.add('light');
        document.getElementById('footer_nav').classList.add('light');
      }
    }
  }
</script>
...
<style lang="less">
  @black: #121212;
  @label: #ffffff; //参考apple design principle
